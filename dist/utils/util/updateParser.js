        ...
        for (var [key, valueData] of values) {
            ...
            if (operator == '$inc') {
                if (String(key).includes('.')) {
                    ...
                    lodash_1.default.update(parsedUpdate, key, (upt) => (upt || 0) + valueData);
                }
                else {
                    await (0, ruleParser_1.ruleParser)(key, rules, valueData);
            ...
            if (operator == '$dec') {
                if (String(key).includes('.')) {
                    await (0, ruleParser_1.ruleParser)(key, rules, valueData);
                    lodash_1.default.update(parsedUpdate, key, (value) => (value || 0) - valueData);
                }
                else {
                    await (0, ruleParser_1.ruleParser)(key, rules, valueData);
                    parsedUpdate[key] = parsedUpdate[key] - value;
            ...
            if (operator == '$mul') {
                if (String(key).includes('.')) {
                    await (0, ruleParser_1.ruleParser)(key, rules, valueData);
                    lodash_1.default.update(parsedUpdate, key, (value) => value * valueData);
                }
                else {
                    await (0, ruleParser_1.ruleParser)(key, rules, valueData);
                    parsedUpdate[key] = parsedUpdate[key] * value;
            ...
            if (operator == '$min') {
                if (String(key).includes('.')) {
                    await (0, ruleParser_1.ruleParser)(key, rules, valueData);
                    lodash_1.default.update(parsedUpdate, key, (value) => Math.min(value, valueData));
                }
                else {
                    await (0, ruleParser_1.ruleParser)(key, rules, valueData);
            ...
            if (operator == '$max') {
                if (String(key).includes('.')) {
                    await (0, ruleParser_1.ruleParser)(key, rules, valueData);
                    lodash_1.default.update(parsedUpdate, key, (value) => Math.max(value, valueData));
                }
                else {
                    await (0, ruleParser_1.ruleParser)(key, rules, valueData);
            ...
            if (operator == '$sqrt') {
                if (String(key).includes('.')) {
                    await (0, ruleParser_1.ruleParser)(key, rules, valueData);
                    lodash_1.default.update(parsedUpdate, key, (value) => Math.sqrt(value));
                }
                else {
                    await (0, ruleParser_1.ruleParser)(key, rules, valueData);
            ...
            if (operator == '$floor') {
                if (String(key).includes('.')) {
                    await (0, ruleParser_1.ruleParser)(key, rules, valueData);
                    lodash_1.default.update(parsedUpdate, key, (value) => Math.floor(value));
                }
                else {
                    await (0, ruleParser_1.ruleParser)(key, rules, valueData);
            ...
            if (operator == '$random') {
                if (String(key).includes('.')) {
                    await (0, ruleParser_1.ruleParser)(key, rules, valueData);
                    lodash_1.default.update(parsedUpdate, key, (value) => Math.random());
                }
                else {
                    await (0, ruleParser_1.ruleParser)(key, rules, valueData);
            ...
            if (operator == '$abs') {
                if (String(key).includes('.')) {
                    await (0, ruleParser_1.ruleParser)(key, rules, valueData);
                    lodash_1.default.update(parsedUpdate, key, (value) => Math.abs(value));
                }
                else {
                    await (0, ruleParser_1.ruleParser)(key, rules, valueData);
            ...
            if (operator == '$ceil') {
                if (String(key).includes('.')) {
                    await (0, ruleParser_1.ruleParser)(key, rules, valueData);
                    lodash_1.default.update(parsedUpdate, key, (value) => Math.ceil(value));
                }
                else {
                    await (0, ruleParser_1.ruleParser)(key, rules, valueData);
            ...
            if (operator == '$pow') {
                if (String(key).includes('.')) {
                    await (0, ruleParser_1.ruleParser)(key, rules, valueData);
                    lodash_1.default.update(parsedUpdate, key, (value) => Math.pow(value, valueData));
                }
                else {
                    await (0, ruleParser_1.ruleParser)(key, rules, valueData);
            ...
            if (operator == '$toFixed') {
                if (String(key).includes('.')) {
                    await (0, ruleParser_1.ruleParser)(key, rules, valueData);
                    lodash_1.default.update(parsedUpdate, key, (value) => {
            ...
            if (operator == '$round') {
                if (String(key).includes('.')) {
                    await (0, ruleParser_1.ruleParser)(key, rules, valueData);
                    lodash_1.default.update(parsedUpdate, key, (value) => Math.round(value));
                }
                else {
                    await (0, ruleParser_1.ruleParser)(key, rules, valueData);
            ...
            if (operator == '$trunc') {
                if (String(key).includes('.')) {
                    await (0, ruleParser_1.ruleParser)(key, rules, valueData);
                    lodash_1.default.update(parsedUpdate, key, (value) => Math.trunc(value));
                }
                else {
                    await (0, ruleParser_1.ruleParser)(key, rules, valueData);
